          ...
          <div className="flex flex-1 items-center">
            <div className="mx-auto w-full max-w-md py-10">
              ...
              <h1 className="mt-4 font-display text-3xl font-semibold leading-tight tracking-tight text-[#1C1917] md:text-4xl">
                Comece a vender mais<span className="text-ember"> hoje mesmo.</span>
              </h1>
              ...
              >
                ...
                <label className="block">
                  <span className="mb-1 block text-xs font-semibold text-[#1C1917]/80">
                    Nome do restaurante
                  </span>
                  <input
                ...
                <label className="flex cursor-pointer items-start gap-2.5 pt-1">
                  <input
                    ...
                    className="mt-0.5 h-4 w-4 flex-shrink-0 cursor-pointer accent-ember"
                  />
                  <span className="text-sm text-[#1C1917]/65">
                    Aceito os{" "}
                    <a href="#" className="font-medium text-ember hover:underline">
                      Termos de Uso
                    </a>{" "}
                    e a{" "}
                    <a href="#" className="font-medium text-ember hover:underline">
