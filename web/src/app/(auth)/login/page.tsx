        ...
        <div className="flex flex-1 flex-col justify-center px-4 py-10 sm:px-5 lg:pl-[max(1.25rem,calc((100vw-80rem)/2+1.25rem))] lg:pr-10">
          <div className="w-full max-w-sm">
            ...
            <div className="mb-6 inline-flex items-center gap-1.5 rounded-full border border-[#E8E0D6] bg-white px-3 py-1.5 shadow-soft">
              ...
              <span className="text-xs font-medium text-[#1C1917]">Bem-vindo de volta</span>
            </div>

            {/* Title */}
            <h1 className="mb-2 text-3xl font-bold leading-tight text-[#1C1917]">
              Entre na sua{" "}
              <span className="text-[#EA580C]">central de pedidos.</span>
            </h1>
            ...
            >
              ...
              <button
                ...
                className="mt-2 flex h-12 w-full items-center justify-center gap-2 rounded-lg bg-[#EA580C] font-semibold tracking-wide text-white transition-colors hover:bg-[#C2410C] disabled:opacity-60"
              >
